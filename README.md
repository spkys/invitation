...
4. **참석 및 문의 직통 연락처**
   - 아들 박보현 / 딸 박지현 전화 걸기(`tel:`) 및 문자 보내기(`sms:`) 버튼
5. **축하 메시지 (덕담 방명록)**
   - 브라우저 LocalStorage 기반으로 작성 즉시 카드 형태로 축하글 등록
6. **소셜 공유 최적화**
...
## 📝 사용자 설정 안내 (전화번호 수정)
`index.html` 파일의 **참석 및 문의** 섹션(약 260~290번째 줄)에서 `010-0000-0000`으로 되어 있는 번호를 실제 연락처로 변경하시면 됩니다.

```html
<!-- 아들 박보현 -->
<a href="tel:010-1234-5678" class="contact-btn" title="전화하기">...</a>
<a href="sms:010-1234-5678" class="contact-btn" title="문자보내기">...</a>

<!-- 딸 박지현 -->
<a href="tel:010-9876-5432" class="contact-btn" title="전화하기">...</a>
<a href="sms:010-9876-5432" class="contact-btn" title="문자보내기">...</a>
```
